...
public class DisplayTests extends Assertions {
    ...
    public void stickManDisplayTest() {
        ...
        verify(guiMock).drawSprite2(stickMan.getPosition().getX(), stickMan.getPosition().getY(), Sprites.getStickManRight(), '#', "#00ff00");
    }
    ...
    public void stickManMovingDisplayTest() {
        ...
        StickManViewer stickManViewer = new StickManViewer();
        stickManViewer.display(stickMan, guiMock);
        verify(guiMock).drawSprite2(stickMan.getPosition().getX(), stickMan.getPosition().getY(), Sprites.getStickManMovingRight(), '#', "#0000ff");
        stickMan.setDirection(Direction.Left);
        stickManViewer.display(stickMan, guiMock);
        verify(guiMock).drawSprite2(stickMan.getPosition().getX(), stickMan.getPosition().getY(), Sprites.getStickManMovingLeft(), '#', "#0000ff");
        ...
        stickManViewer.display(stickMan, guiMock);
        verify(guiMock).drawSprite2(stickMan.getPosition().getX(), stickMan.getPosition().getY(), Sprites.getStickManShootingUp(), '#', "#00ff00");
        assertFalse(stickMan.isShooting());

        stickMan.setShooting(true);
        stickMan.setDirection(Direction.Down);
        stickManViewer.display(stickMan, guiMock);
        verify(guiMock).drawSprite2(stickMan.getPosition().getX(), stickMan.getPosition().getY(), Sprites.getStickManShootingDown(), '#', "#00ff00");
        assertFalse(stickMan.isShooting());

        stickMan.setShooting(true);
        stickMan.setDirection(Direction.Left);
        stickManViewer.display(stickMan, guiMock);
        verify(guiMock).drawSprite2(stickMan.getPosition().getX(), stickMan.getPosition().getY(), Sprites.getStickManShootingLeft(), '#', "#00ff00");
        assertFalse(stickMan.isShooting());

        stickMan.setShooting(true);
        stickMan.setDirection(Direction.Right);
        stickManViewer.display(stickMan, guiMock);
        verify(guiMock).drawSprite2(stickMan.getPosition().getX(), stickMan.getPosition().getY(), Sprites.getStickManShootingRight(), '#', "#00ff00");
        assertFalse(stickMan.isShooting());
    }
    ...
    public void robotDisplayTest() {
        ...
        verify(guiMock).drawSprite2(robot.getPosition().getX(), robot.getPosition().getY(), Sprites.getRobot(), '#', "#ff0000");
    }
    ...
    public void bulletDisplay() {
        ...
        verify(guiMock).drawSprite2(bullet1.getPosition().getX(), bullet1.getPosition().getY(), Sprites.getHorizontalBullet(), '#', "#ffffff");
        bulletViewer.display(bullet2, guiMock);
        verify(guiMock).drawSprite2(bullet2.getPosition().getX(), bullet2.getPosition().getY(), Sprites.getVerticalBullet(), '#', "#ffffff");
    }
    ...
    public void levelInfoViewer() {
        ...
        verify(guiMock).drawSprite2(30,315, Sprites.getLEVEL(), '#', "#ffffff");
        verify(guiMock).drawSprite2(80, 315, Sprites.getNumber(Game.getLevel()), '#', "#ffffff");
    }
    ...
    public void livesInfoViewer() {
        ...
        verify(guiMock).drawSprite2(310,315, Sprites.getHeart(), '#', "#ff0000");
        verify(guiMock).drawSprite2(406,315, Sprites.getHeart(), '#', "#221111");
    }
    ...
    public void scoreInfoViewer() {
        ...
        verify(guiMock).drawSprite2(135,315, Sprites.getScore(), '#', "#ffffff");
        verify(guiMock).drawSprite2(215,315, Sprites.getNumber(1), '#', "#ffffff");
        verify(guiMock).drawSprite2(229,315, Sprites.getNumber(2), '#', "#ffffff");
        verify(guiMock).drawSprite2(243,315, Sprites.getNumber(3), '#', "#ffffff");
        verify(guiMock).drawSprite2(257,315, Sprites.getNumber(4), '#', "#ffffff");
        StickMan.setScore(0);
    }
}
